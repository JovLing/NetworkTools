function main(config) {
  ...
  config['rules'] = [
    ...
    "RULE-SET,github,海外媒体｜🐰优兔",
    "RULE-SET,whatsapp,海外媒体｜🐰优兔",
    "RULE-SET,discord,海外媒体｜🐰优兔",
    "RULE-SET,twitter,海外媒体｜🐰优兔",
    "RULE-SET,facebook,海外媒体｜🐰优兔",
    "RULE-SET,instagram,海外媒体｜🐰优兔",
    "RULE-SET,reddit,海外媒体｜🐰优兔",
    "RULE-SET,twitch,海外媒体｜🐰优兔",
    "RULE-SET,crypto,海外媒体｜🐰优兔",
    "RULE-SET,ai,AI｜🐰优兔",
